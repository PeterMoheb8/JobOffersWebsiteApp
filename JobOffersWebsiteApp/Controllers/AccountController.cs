...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model , HttpPostedFileBase upload)
        {
            ...
            if (ModelState.IsValid)
            {
                ViewBag.UserType = new SelectList(db.Roles.Where(a => !a.Name.Contains("Administrator")).ToList(),
                           "Name", "Name");
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email , UserType = model.UserType , ImageProfile = model.ImageProfile };
        ...
        public ActionResult EditProfile()
        {
            ...
            profile.ImageProfile = user.ImageProfile;
            return View(profile);
        }
        [HttpPost]
        public ActionResult EditProfile(EditProfileViewModel profile , HttpPostedFileBase upload)
        {
            ...
            //string oldPath = Path.Combine(Server.MapPath("~/Upload"),profile.ImageProfile);
            ...
            //    upload.SaveAs(path);
            //    profile.ImageProfile = upload.FileName;
